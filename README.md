...
[Documentação da função _saveXML_ para a criação de um arquivo XML](https://www.rdocumentation.org/packages/XML/versions/3.98-1.20/topics/saveXML)

[Documentação da função _read XML_ para a leitura de um arquivo XML](https://www.rdocumentation.org/packages/tm/versions/0.7-6/topics/readXML)
